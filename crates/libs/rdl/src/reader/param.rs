...
impl<'a, 'b: 'a> Encoder<'a, 'b> {
    ...
    pub(super) fn param(&self, param: &syn::PatType) -> Result<Param, Error> {
    ...
    pub(super) fn bare_param(&self, param: &syn::BareFnArg) -> Result<Param, Error> {
    ...
    pub(super) fn collect_params(&self, sig: &syn::Signature) -> Result<Vec<Param>, Error> {
        let mut params = vec![];
